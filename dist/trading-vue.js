/*!
 * TradingVue.JS - v1.0.2 - Wed Jul 26 2023
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/components/overlays/Alphabetical.vue?vue&type=script&lang=js&
// Spline renderer. (SMAs, EMAs, TEMAs...
// you know what I mean)
// TODO: make a real spline, not a bunch of lines...
// Adds all necessary stuff for you.
...
/* harmony default export */ const Alphabeticalvue_type_script_lang_js_ = ({
  name: 'Alphabetical',
  mixins: [overlay],
  methods: {
    meta_info: function meta_info() {
    ...
    draw: function draw(ctx) {
      ...
      if (!this.skip_nan) {
        for (var k = 0, n = data.length; k < n; k++) {
          ...
          var x = layout.t2screen(p[0]);
          var y = layout.$2screen(p[i]);
          ctx.fillText(utils.numberToAlphabet(k), x + this.POINT_TITLE_OFFSET, y + this.POINT_TITLE_OFFSET);
          ctx.lineTo(x, y);
        }
      } else {
        var skip = false;
  ...
  data: function data() {
    return {
      POINT_TITLE_OFFSET: 8,
      COLORS: ['#42b28a', '#5691ce', '#612ff9', '#d50b90', '#ff2316']
    };
  }
});
;// CONCATENATED MODULE: ./src/components/overlays/Alphabetical.vue?vue&type=script&lang=js&
 /* harmony default export */ const overlays_Alphabeticalvue_type_script_lang_js_ = (Alphabeticalvue_type_script_lang_js_); 
;// CONCATENATED MODULE: ./src/components/overlays/Alphabetical.vue
var Alphabetical_render, Alphabetical_staticRenderFns
;
...
/* normalize component */
;
var Alphabetical_component = normalizeComponent(
  overlays_Alphabeticalvue_type_script_lang_js_,
  Alphabetical_render,
  Alphabetical_staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var Alphabetical_api; }
Alphabetical_component.options.__file = "src/components/overlays/Alphabetical.vue"
/* harmony default export */ const Alphabetical = (Alphabetical_component.exports);
...
/* harmony default export */ const Gridvue_type_script_lang_js_ = ({
  ...
  created: function created() {
    ...
    this._list = [Spline, Splines, Range, Trades, Channel, Segment, Candles, Volume, Splitters, LineTool, RangeTool, Alphabetical].concat(this.$props.overlays);
